...
@Service
public class UploadResourceListService {

    @Autowired
    private ResourceListMapper resourceListMapper;

    public PicUploadResult saveResourcelist(MultipartFile file, ResourceList resourceList, Integer id) {
        ...
        try {
            ...
            resourceListMapper.saveResourcelist(resourceList);
            return result;
