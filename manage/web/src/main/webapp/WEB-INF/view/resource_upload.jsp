                            ...
                            <div class="register-box-con2">
                                <div class="register-box-con2-box clearfix mar-bottom20">
                                    <label class="register-box-con2-box-left"><em class="bitian">*</em><em
                                            style="color: #ffffff  ">资源名称</em></label>
                                ...
                                <div class="register-box-con2-box clearfix mar-bottom20">
                                    <label class="register-box-con2-box-left"><em class="bitian"></em><em
                                            style="color: #ffffff  ">资源类型</em></label>
                                    <div class="register-box-con2-box-right">
                                ...
                                <div class="register-box-con2-box clearfix mar-bottom20">
                                    <label class="register-box-con2-box-left"><em class="bitian"></em><em
                                            style="color: #ffffff  ">资源分类</em></label>
                                    <div class="register-box-con2-box-right">
                                ...
                                <div class="register-box-con2-box clearfix mar-bottom20">
                                    <label class="register-box-con2-box-left"><em class="bitian"></em><em
                                            style="color: #ffffff  ">资源描述</em></label>
                                    <div class="register-box-con2-box-right">
                                ...
                                <div class="register-box-con2-box clearfix mar-bottom20 mar-top50">
                                    ...
                                    <div class="register-box-con2-box-right">
                                        <input type="submit" value="确认上传" class="login-box-cen-form-button w380"
                                               id="reg_info_submit"/>
                                    </div>
                                </div>
