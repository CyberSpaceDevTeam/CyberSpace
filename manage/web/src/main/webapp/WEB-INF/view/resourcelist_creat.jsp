...
<div class="bg">
    <div class="drag" style="width: 90%;margin-top: 3%;margin-left: 5%">
        ...
        <div class="upload_edit_area">
            <form method="post" action="/creatResourcelist/${sessionScope.user.userId}" enctype="multipart/form-data"
                ...
                <div class="register-box">
                    <div class="wrap">
                        <div class="register-box-con2">
                            <div class="register-box-con2-box clearfix mar-bottom20">
                                ...
                                <div class="register-box-con2-box-right">
                                    <input type="text" class="login-box-cen-form-input w358"
                                           placeholder="请输入清单名称，不超过20个字" id="reg_info_company" name="resourcelistName"/>
                                    <label id="reg_info_company_text" class="err err-top40">请输入清单名称，不超过20个字</label>
                                </div>
                            </div>
                            <div class="register-box-con2-box clearfix mar-bottom20">
                                <label class="register-box-con2-box-left"><em class="bitian">*</em><em
                            ...
                            <div class="register-box-con2-box clearfix mar-bottom20">
                                <label class="register-box-con2-box-left"><em class="bitian"></em><em
                                        style="color: #ffffff  ">清单描述</em></label>
                                <div class="register-box-con2-box-right">
                                    <textarea class="login-box-cen-form-textarea w358 h88" id="reg_info_textarea"
                                              placeholder="描述不超过200个字....." name="resourcelistDesc"></textarea>
                            ...
                            <div class="register-box-con2-box clearfix mar-bottom20 mar-top50">
                                ...
                                <div class="register-box-con2-box-right">
                                    <input type="submit" value="创建清单" class="login-box-cen-form-button w380"
                                           id="reg_info_submit"/>
                                </div>
                            </div>
        ...
        var regconfig = [
            {
                ...
                rule: [{reg: /^.+$/, text: "清单不能为空"}, {reg: /^.{1,20}$/, text: "清单名称不超过20个字"}]
            }
        ];
        tbdValidate(
            regconfig,
