        ...
        <div>
            <div class="more_art_main">
                <div class="page-header shadow_effect">
                    <h1>作者全部作品
                        <small>人生路漫漫，吾将上下而求索</small>
                    </h1>
                </div>
                <c:forEach items="${pageUtils.pageList }" var="article">
                    <div class="panel panel-default">
                        <div class="panel-heading"><a
                                href="/showArtiById?articleId=${article.articleId }&articleName=${article.articleName }">${article.articleName }</a>
                        </div>
                    ...
                    <ul class="pagination pagination-lg">
                        <li>
                            <c:if test="${pageUtils.currPage - 1 } &gt 1">
                                <a href="/moreArticle?currPage=${pageUtils.currPage - 1 }" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </c:if>
                            <a href="/moreArticle?currPage=1" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                        <c:forEach begin="1" end="${pageUtils.totalPage }" varStatus="status">
                            <li><a href="/moreArticle?currPage=${status.index }" class="to_small">${status.index }</a>
                            </li>
                        </c:forEach>
                        ...
                        <li>
                            ...
                            <a href="/moreArticle?currPage=${pageUtils.totalPage }" aria-label="Next">
                            ...
                            <div class="to_small col-xs-12 col-sm-12 col-md-12 col-lg-6 shadow_effect">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <p>${column.columnDesc }</p>
                                            ${column.columnArticleCount }篇
                                        <p>
                                            <a href="/checkColumn?columnId=${column.columnId }"
                ...
                <div style="float: left;padding-top: 50px" class="list-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <c:forEach items="${topList }" var="article">
                        <a href="#" class="list-group-item">
                            <span class="badge">${article.clickCount }</span>${article.articleName }
                        </a>
                    </c:forEach>
                </div>
            </div>
