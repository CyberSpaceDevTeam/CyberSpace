...
public class ResourceService {
    ...
    public PicUploadResult saveResource(MultipartFile file, Resource resource, Integer id) {
        ...
        try {
            ...
            resource.setResourcePicture(urlPath + "/" + fileName);
    ...
    public List<Type> findTypeAll() {
        return resourceMapper.findTypeAll();
    }

    public List<Category> findCategoryAll() {
        return resourceMapper.findCategoryAll();
    }
}
