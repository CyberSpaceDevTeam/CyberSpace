...
<div class="bg">
    <div class="drag" style="width: 90%;margin-top: 3%;margin-left: 5%">
        ...
        <div class="upload_edit_area">
            ...
            <form method="post" action="/fileUpload/${sessionScope.user.userId}" enctype="multipart/form-data"
                        ...
                        <div class="wrap">
                            <div class="register-box-con2">
                                <div class="register-box-con2-box clearfix mar-bottom20">
                                    <label class="register-box-con2-box-left"><em class="bitian">*</em><em
                                            style="color: #ffffff  ">资源清单名称</em></label>
                                    <div class="register-box-con2-box-right">
                                        <input type="text" class="login-box-cen-form-input w358"
                                               placeholder="请输入资源清单名称，不超过20个字" id="reg_info_company" name="resourceName"
                                               value="${rlist.resourcelistName}/>
                                        <label id=" reg_info_company_text" class="err
                                        err-top40">请输入资源清单名称，不超过20个字</label>
                                    </div>
                                </div>
                                <div class="register-box-con2-box clearfix mar-bottom20">
                                    <label class="register-box-con2-box-left"><em class="bitian">*</em><em
                                            style="color: #ffffff  ">粗略图</em></label>
                                    <div class="register-box-con2-box-right">
                                        <label class="register-box-con2-box-upload">
                                            <input type="file" name="fileName" id="reg_info_file"
                                                   src="${rlist.resourcelistPicture}"/>
                                            <div class="register-box-con2-box-upload-ti"><em
                                                    id="reg_info_file_w">上传</em><img id="reg_info_file_base64"
                                                                                     tyle="display:none;"/></div>
                                        </label>
                                        <p class="register-box-con2-box-pw" style="color: #f7f7f7">
                                            1.支持图片格式JPG/PNG，图片大小不超过2M</p>
                                ...
                                <div><input type="text" name="resourcePicture" value="${rlist.resourcelistPicture}"
                                            hidden="hidden"></div>
                                <div class="register-box-con2-box clearfix mar-bottom20">
                                    <div class="register-box-con2-box clearfix mar-bottom20">
                                        <label class="register-box-con2-box-left"><em class="bitian"></em><em
                                                style="color: #ffffff  ">资源清单描述</em></label>
                                        <div class="register-box-con2-box-right">
                                    <textarea class="login-box-cen-form-textarea w358 h88" id="reg_info_textarea"
                                              placeholder="描述不超过200个字....." name="resourceDesc"></textarea>
        ...
        var regconfig = [
            {
                ...
                rule: [{reg: /^.+$/, text: "资源清单名称不能为空"}, {reg: /^.{1,20}$/, text: "资源清单名称不超过20个字"}]
            }
        ];
        tbdValidate(
            regconfig,
